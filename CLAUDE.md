...
- [x] **ASC display name FIXED 2026-07-21**: was still "Spinelist" (single app record, id 6792376485, one universal record already covering iOS+macOS — no separate Mac merge needed). "Spine", "Spinal", "Colophon", and "Spinewell" were all already taken by other Apple accounts; renamed to **"Bindwise"** via `asc-name-creator` skill (superseded an earlier same-day fallback to "Spynne" — user asked for a better name).
