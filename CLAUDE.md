...
- [x] **ASC display name FIXED 2026-07-21**: was still "Spinelist" (single app record, id 6792376485, one universal record already covering iOS+macOS — no separate Mac merge needed). "Spine" and "Spinal" were both already taken by other Apple accounts; renamed to **"Spynne"** via `asc-name-creator` skill.
